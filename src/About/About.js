      ...
      <div className='full-viewport-container'>
          ...
          <div className='main-panel'>
            ...
            <label style={{display: 'flex', paddingBottom: '20px', fontFamily: 'PixTimesSoft', color: 'rgba(171, 170, 255, 1)', alignContent: 'center', fontSize: '20.5px', width: '50%'}}>
                Scaredcrow is a Grunge-Punk-Psychedelic band from Raleigh, NC started in 2022 by Aiden Wall, Spencer Gagnon, Romir Seth, and Matt Matunis. We've come a long way since the garage, performing live across the Triangle area. We are currently working towards releasing our debut album. Stay Tuned! 
            </label>
